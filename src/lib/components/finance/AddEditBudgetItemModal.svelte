  ...
  <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
    ...
    <form on:submit|preventDefault={handleSubmit} class="space-y-4">
      ...
      <label class="block">
        ...
        <input bind:value={budgetItem.category} placeholder="Category" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
      </label>
